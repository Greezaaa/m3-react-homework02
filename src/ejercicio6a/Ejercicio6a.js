...
const Ejercicio6a = () => {
    ...
    let [libros, setLibros] = useState(libreria.libros)

    return (
        <>
            <Main libros={libros} setLibros={setLibros} />
            <Footer libro={libros[1]} setLibros={setLibros} libros={libros} />
        </>
    )
}

export default Ejercicio6a